...
import {
  mockNewestReservation,
  mockReservation,
  mockReservationDefined,
} from "@/mocks/reservation";
...
describe("PanelClient component", () => {
  it("renders PanelClient correctly", () => {
    render(
      <PanelClient
        newestReservation={mockNewestReservation}
        currentUser={mockCurrentUser}
        reservationsCount={2}
        pastReservations={[]}
        allUsers={10}
        reservations={mockReservationDefined}
        purchased={[]}
      />
    );
