...
const AdvertBlock = () => {
  return (
    ...
    <div className="bg-gradient-to-r from-red-500 to-blue-500 max-w-4xl flex items-center justify-center rounded-3xl shadow-2xl hover:scale-105 transition-all   duration-1000 ">
