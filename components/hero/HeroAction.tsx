...
const HeroAction = () => {
  return (
    <div className="flex flex-col-reverse lg:flex-row space-y-10 lg:space-y-0 mx-10 pb-5 lg:pb-0">
        {/* Left side */}
        <section className="w-full relative lg:w-1/2 flex items-center justify-center lg:justify-start pb-10 ">
            ...
            <div className="absolute z-30 bottom-0 lg:bottom-40 lg:right-10 xl:right-20 2xl:right-40 ">
                <ScoreBox title="Visits" desc="Create reservation anytime anyday " icon={CalendarCheck} action/>
            </div>
            <div className="z-10 hidden lg:block absolute lg:-right-32 xL:-right-20  2xl:right-40 bottom-0">
              <CurvyLine />
            </div>
        </section>
