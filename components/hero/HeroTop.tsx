...
const HeroTop = () => {
  return (
    <div className="flex flex-col lg:flex-row space-y-10 lg:space-y-0 mx-10">
        ...
        <HeroHeading title="Feel Yourself in a complete new style" desc="We are providing the best possible services for our customers" href="/"/>
        </section>

        {/* Right side */}
        <section className="w-full relative lg:w-1/2 flex items-center justify-center pb-10 ">
            <div className="z-20">
            <HeroImage src={'/images/pexels-photo-2608582.jpeg'}/>
            </div>
